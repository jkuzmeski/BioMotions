...
python protomotions/inference_agent.py --simulator isaaclab --checkpoint results/mimic_base_v2/last.ckpt
...
python protomotions/train_agent.py --robot-name smpl_lower_body_170cm --simulator isaaclab --experiment-path examples/experiments/mimic/transformer.py --experiment-name mimic_base --motion-file biomechanics_retarget\processed_data\S02_170_long\packaged_data\S02_long.pt --num-envs 512 --batch-size 2048 --use-wandb
